...
class TestCli(TestCase):
    ...
    def test_scan_single__should_process_no_verify(self):
        mock = responses.upsert(
            responses.HEAD, "https://example.com", match=[matchers.request_kwargs_matcher({"verify": False})]
        )
    ...
    def test_scan_single__should_process_timeout(self):
        mock = responses.upsert(
            responses.HEAD, "https://example.com", match=[matchers.request_kwargs_matcher({"timeout": 30})]
        )
